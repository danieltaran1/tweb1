...
<body class=" px-30">
    ...
    <main>
        ...
        <section>
            ...
            <div class="flex flex-col justify-center items-center gap-5">
                <div class="font-bold text-2xl">How it works</div>
                <div class="flex flex-row jusitfy gap-15">
                    <div class="flex flex-row items-center gap-3">
                        <div>
                            <div class="group flex items-center gap-4 p-4 rounded-full border border-slate-100 bg-white shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                                <img src="img/Chroma2.png" alt="Case" class="w-14 h-14 object-contain z-10 drop-shadow-md">
                            </div>
                        </div>
                        <div class="font-bold">1. Select a Case</div>
                    </div>
                    
                    <div class="flex flex-row items-center gap-3">
                        <div>
                            <div class="group flex items-center gap-4 p-4 rounded-full border border-slate-100 bg-white shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                                <img src="img/key.png" alt="Case" class="w-14 h-14   object-contain z-10 drop-shadow-md">
                            </div>
                        </div>
                        <div class="font-bold">2. Open for FREE</div>
                    </div>
                    ...
                    <div class="flex flex-row items-center gap-3">
                        ...
                        <div class="font-bold">3. Win skins!</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            <div>
                <div>
                    <div class="px-4 py-7 text-4xl flex font-bold">Available cases:</div>
                </div>
                <div class="overflow-hidden relative w-full items-stretch justify-center">
                        <div class="absolute left-0 top-0 bottom-0 w-32 z-10 pointer-events-none" style="background: linear-gradient(to right, rgb(255,255,255), transparent)"></div>
                        <div class="absolute right-0 top-0 bottom-0 w-32 z-10 pointer-events-none" style="background: linear-gradient(to left, rgb(255,255,255), transparent)"></div>
