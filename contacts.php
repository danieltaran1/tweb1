...
<body class="px-30">
    ...
    <main>
        <div class="h-150 bg-zinc-100 rounded-4xl flex flex-row items-center gap-10 justify-center p-10">
            <div class="flex flex-col gap-10">
                <div class="text-5xl font-bold">Contact us</div>
                <div class="text-xl">For any questions please contact us at:</div>
                <div class="flex flex-col gap-5">
                    <div class="text-xl font-bold">Email: contact@cs2foryou.com</div>
                    <div class="mt-2 border rounded-md border-gray-400">
                    ...
                    <div class="flex justify-left">
                        <div class="bg-sky-400 p-3 rounded-full text-white font-bold cursor-pointer hover:bg-sky-500">Submit</div>
                    </div>

                    <div class="flex flex-col gap-4 py-7">
                        <div class="font-bold">Or follow us on our social</div>
            ...
            <div>
                <div>
                    <img src="img/contacts2.png" alt="" class="h-130 rounded-4xl tilt">
                </div>
            </div>
        </div>
    </main>
