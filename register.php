    ...
    <main>
                ...
                <div class="relative w-full max-w-[300px] bg-white rounded-3xl shadow-xl p-6 sm:p-8 flex flex-col z-15">
                    ...
                    <form action="register.php" method="POST" class="flex flex-col space-y-4 w-full">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input id="email" type="email" name="email" placeholder="Enter Email" required class="block w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-800 placeholder:text-slate-400 focus:border-[#1e3a8a] focus:outline-none focus:ring-1 focus:ring-[#1e3a8a] transition-colors shadow-sm" />
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="relative">
                                <input id="password" type="password" name="password" placeholder="Enter Password" required class="block w-full rounded-lg border border-slate-300 bg-white px-3 py-2 pr-12 text-sm text-slate-800 placeholder:text-slate-400 focus:border-[#1e3a8a] focus:outline-none focus:ring-1 focus:ring-[#1e3a8a] transition-colors shadow-sm" />
                                <span id="toggle-password"
                                    class="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-slate-400 text-xs select-none hover:text-slate-600">
                                    Show
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col justify-center items-center pt-2 pb-4 space-y-1">
                            <div class="text-xs text-slate-500">Already have an account?</div>
                            <a href="login.php" class="text-sm font-semibold text-[#1e3a8a] hover:text-blue-900 hover:underline">Login</a>
                        </div>
        ...
        <div class="py-10 hidden">
            <div class="flex flex-row justify-between">
                <div class="font-bold p-4 text-4xl">My Skins:</div>
                <div class="flex flex-row gap-4 items-center px-10">
                    <div>Knifes</div>
                    <div>Gloves</div>
                    <div>Pistols</div>
                    <div>Rifles</div>
            ...
            <div class=" font-bold p-4 text-4xl  rounded-4xl ">
                <div class="grid grid-cols-6 gap-10 flex justify-center items-center p-4">
                    <div class="flex justify-center p-4 py-7 bg-white rounded-3xl outline-2 outline-gray-300">.</div>
                    <div class="flex justify-center p-4 py-7 bg-white rounded-3xl outline-2 outline-gray-300">.</div>
                    <div class="flex justify-center p-4 py-7 bg-white rounded-3xl outline-2 outline-gray-300">.</div>
                    <div class="flex justify-center p-4 py-7 bg-white rounded-3xl outline-2 outline-gray-300">.</div>
                    <div class="flex justify-center p-4 py-7 bg-white rounded-3xl outline-2 outline-gray-300">.</div>
