...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Verificăm dacă email-ul sau nickname-ul există deja
    ...
    if ($check_result->num_rows > 0) {
        ...
        if ($row['email'] === $user_email) {
            ...
            header("Location: register.php?error=nick_taken");
            exit();
        }
    } else {
        // Criptăm parola
        ...
        if ($conn->query($sql) === TRUE) {
            // Trimitem utilizatorul la Login cu un mesaj de succes
...
<head>
    ...
    <title>Register - CS2-foryou</title>
                ...
                <div class="relative w-full max-w-[300px] bg-white rounded-3xl shadow-xl p-6 sm:p-8 flex flex-col z-15">
                    ...
                    <form action="register.php" method="POST" class="flex flex-col space-y-4 w-full">
                        ...
                        <div class="flex flex-col">
                            <label for="email" class="text-sm font-semibold text-slate-600 mb-1 ml-1">Email</label>
